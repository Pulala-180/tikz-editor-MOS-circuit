\begin{tikzpicture}
  ...
  \begin{scope}[shift={(0,3.1)}]
    ...
    \end{scope}
  \draw[thick, line cap=round] (0.73,2.6) -- (0.73,1.82);
  \begin{scope}[shift={(0.73,1.822)}]
...
$};
  ...
  \begin{scope}[shift={(-0.9,3.1)}]
    ...
    \end{scope}
  \draw[thick, line cap=round] (0.73,3.6) -- (0.73,4.58);
  \begin{scope}[shift={(0.73,4.58)}]
      \coordinate (node_Rx2.b) at (0,0);
      \draw[thick, line cap=round] (0,0) -- (0,0.15) -- (0.15,0.19) -- (-0.15,0.27) -- (0.15,0.35) -- (-0.15,0.43) -- (0.15,0.51) -- (-0.15,0.59) -- (0,0.63) -- (0,0.78);
      \node[right] at (0.25,0.39) {$R_D$};
      \coordinate (node_Rx2.t) at (0,0.78);
    \end{scope}
  \draw[thick, line cap=round] (0.73,5.36) -- (0.73,6.12);
  \begin{scope}[shift={(0.73,6.12)}]
  ...
  \draw[thick, line cap=round] (0.75,4) -- (1.63,4);
  \begin{scope}[shift={(1.48,4)}]
    ...
    \end{scope}
  \draw[thick, line cap=round] (0.73,1.04) -- (0.73,0.94);
  \draw[thick, line cap=round] (0.73,0.94) -- (0.73,0.56);

  \begin{scope}[shift={(0.73,0.56)}]
