...
TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "resistor_v": {
        ...
        "body": [
            ...
            r"\draw[line width=0.32mm, line cap=round] (node_{id}_bottom) -- (0,-0.195) -- (0.15,-0.1625) -- (-0.15,-0.0975) -- (0.15,-0.0325) -- (-0.15,0.0325) -- (0.15,0.0975) -- (-0.15,0.1625) -- (0,0.195) -- (node_{id}_top);",
        ],
...
def _render_chord(chord: dict[str, Any]) -> list[str]:
    ...
    return [
        ...
        rf"\draw[{chord.get('style', 'line width=0.32mm')}] ({chord['from']}) {route} ({chord['to']});",
    ]
