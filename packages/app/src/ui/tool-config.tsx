...
function OrthoWireIcon({ size = 20 }: { size?: number }) {
  return (
    <svg viewBox="0 0 20 20" width={size} height={size} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 5H10V15H17" />
...
function ResistorIcon({ size = 20 }: { size?: number }) {
  return (
    <svg viewBox="0 0 20 20" width={size} height={size} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 10H6L7 6L9 14L11 6L13 14L14 10H18" />
    </svg>
  );
}

function MosfetIcon({ size = 20 }: { size?: number }) {
  return (
    <svg viewBox="0 0 20 20" width={size} height={size} fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
      {/* Gate line */}
      <line x1="1.5" y1="10" x2="5.5" y2="10" strokeWidth="1.2" />
      {/* 2 channel lines (thick) */}
      <line x1="7" y1="2" x2="7" y2="18" strokeWidth="2.5" />
      <line x1="10" y1="2" x2="10" y2="18" strokeWidth="2.5" />
      {/* Drain up from right channel */}
      <polyline points="10,2 10,1 15,1" strokeWidth="1.2" />
      {/* Source down from right channel, then right with arrow */}
      <polyline points="10,18 10,19 15,19" strokeWidth="1.2" />
      <polygon points="12.5,18 14.5,19 12.5,20" fill="currentColor" stroke="none" />
    </svg>
  );
}

function PlotIcon({ size = 20 }: { size?: number }) {
  return (
    <svg viewBox="0 0 20 20" width={size} height={size} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 14C4 14 5 6 8 6C11 6 10 14 13 14C16 14 17 6 18 6" />
      <line x1="2" y1="18" x2="2" y2="2" />
      <line x1="2" y1="18" x2="18" y2="18" />
      <polygon points="2,2 1.2,3.5 2.8,3.5" fill="currentColor" stroke="none" />
      <polygon points="18,18 16.5,17.2 16.5,18.8" fill="currentColor" stroke="none" />
    </svg>
  );
}
...
export { CaretDownIcon, ResistorIcon, MosfetIcon, PlotIcon, OrthoWireIcon };
...
export type ToolPopupKind = "bucket-color" | "shape-picker" | "matrix-picker" | "function-plot";
