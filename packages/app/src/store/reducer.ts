...
export function editorReducer(state: EditorState, action: EditorAction): EditorState {
  ...
  switch (action.type) {
    case "NEW_DOCUMENT": {
      ...
      if (!action.isExternal && !action.source && typeof import.meta !== "undefined" && import.meta.hot) {
        import.meta.hot.send?.("sketch:create", { id: next.id, title: next.title, source: next.source });
      }
      break;
    }
